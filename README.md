...
|---|----------|-----------------|
| 1.1 | [1_1_foundational_models.ipynb](module_1/1_1_foundational_models.ipynb) | Initialising and invoking a chat model with `init_chat_model`; customising model parameters; comparing model providers; initialising and invoking an **agent** with `create_agent`; streaming an agent's output token by token |
